...
// Faktyczne zakonczenie sesji
    ...
    if (!isset($_GET["IdPojazd"]) 
        ...
        || !is_numeric($_GET["IdPojazd"])
            ...
            print("<p class='msg error'>Nie można usunąć danych pojazdu, ponieważ nie został on wybrany</p>");
        ...
        // else Jezeli zostal przekazany klucz wiersza do usuniecia
            ...
            print("<h2>Usuwanie danych pojazdu</h2>");

        // Polecenie SQL pobierajace wiersze z tablei bd.
        print("<p class='msg warn'>Czy na pewno usunąć dane pojazdu o identyfikatorze <strong>$IdPojazd</strong>?</p>");

        print("<p><br><a class='btn del' href='pojazd_usun_potw.php?IdPojazd=$IdPojazd'>Tak, usuń</a> <a class='btn' href='pojazd_tabela.php'>Nie, wróć do wykazu</a></p>");
