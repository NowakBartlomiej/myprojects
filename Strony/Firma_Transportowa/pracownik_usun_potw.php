...
// Faktyczne zakonczenie sesji
    ...
    if (!isset($_GET["IdPracownik"]) 
        ...
        || !is_numeric($_GET["IdPracownik"])
            ...
            print("<p class='msg error'>Nie można usunąć danych pracownika, ponieważ są one niekompletne lub błedne</p>");
    ...
    // Jezeli polaczenie zostalo nawiazane
        ...
        if ($rezultat == false) {
            print("<p class='msg error'>Usunięcie danych pracownika <strong>$IdPracownik</strong> z bazy nie powiodlo się</p>");
        }
